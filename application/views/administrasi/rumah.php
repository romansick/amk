...
<div class="main-content">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($kategori as $k) : ?>
                                            <tr>
                                                ...
                                                <td><?= $k['kategori']; ?></td>
                                                <td>
                                                    <a href="<?= base_url('administrasi/edittipe/') . $k['id']; ?>" type="button" class="btn btn-warning btn-sm waves-effect btn-label waves-light"><i class="bx bx-edit label-icon "></i> Edit</a>
                                                    <a href="<?= base_url('administrasi/delete_tipe_rumah/') . $k['id']; ?>" type="button" class="btn btn-danger btn-sm waves-effect btn-label waves-light"><i class="bx bx-trash-alt label-icon "></i> Delete</a>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($lokasi as $l) : ?>
                                            <tr>
                                                ...
                                                <td><?= $l['lokasi']; ?></td>
                                                <td>
                                                    <a href="<?= base_url('administrasi/editlokasi/') . $l['id']; ?>" type="button" class="btn btn-warning btn-sm waves-effect btn-label waves-light"><i class="bx bx-edit label-icon "></i> Edit</a>
                                                    <a href="<?= base_url('administrasi/delete_lokasi_rumah/') . $l['id']; ?>" onclick="return confirm('Menghapus lokasi rumah akan menghapus data rumah yang terdapat pada lokasi tersebut. Lanjut?');" type="button" class="btn btn-danger btn-sm waves-effect btn-label waves-light"><i class="bx bx-trash-alt label-icon "></i> Delete</a>
                                    ...
                                    foreach ($rumah as $l) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('administrasi/delete_rumah/') . $l['id']; ?>" type="button" class="btn btn-danger btn-sm waves-effect btn-label waves-light"><i class="bx bx-trash-alt label-icon "></i> Delete</a>
                                                <a href="<?= base_url('administrasi/detailrumah/') . $l['id']; ?>" type="button" class="btn btn-info btn-sm waves-effect btn-label waves-light"><i class="bx bx-detail label-icon "></i> Detail</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <form action="<?= base_url('administrasi/save_kategori'); ?>" method="post">
    ...
    <div id="lokasi" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="lokasiLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <form action="<?= base_url('administrasi/save_lokasi'); ?>" method="post">
                        <div class="form-group">
    ...
    <div id="rumah" class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="rumahLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-body">
                    <form action="<?= base_url('administrasi/save_rumah'); ?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
