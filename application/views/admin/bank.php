                                    ...
                                    foreach ($bank as $b) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a type="button" href="<?= base_url('administrator/delete_bank/') . $b['id']; ?>" onclick="return confirm('Data akan dihapus?');" class="btn btn-danger btn-sm waves-effect btn-label waves-light"><i class="bx bx-trash-alt label-icon "></i> Delete</a>
