                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div>
                                    <button type="button" class="btn btn-primary btn-sm waves-effect btn-label waves-light" data-toggle="modal" data-target="#myModal"><i class="bx bx-plus label-icon"></i> Tambah Role User</button>
                                </div>
                            </div>
                ...
                <div class="modal-body">
                    <form action="<?= base_url('administrator/role'); ?>" method="post">
                        <div class="form-group">
                            <label>Role</label>
                            <input type="text" class="form-control" name="role" required placeholder="Nama Role">
                        </div>
